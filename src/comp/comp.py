...
class Human:
    """
    Class defined for name and age
    of a list of humans
    """
    ...
    def __repr__(self):
        """
        Formatting Information in an easy to read and understand
        manner for any person looking at data

        Example: Human: Alice, 29 
        """
...
c = [humans[i].name for i in range(0, len(humans)) if humans[i].name[0] in ("C", "D", "E", "F", "G")]
print(c)
